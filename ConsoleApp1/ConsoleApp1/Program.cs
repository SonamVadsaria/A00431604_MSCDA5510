...
namespace MSCDA5510
{
    class ContactGenerator
    {
        ...
        public ContactGenerator()
        {
            ...
            String outputFileName = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/customers.csv";
        ...
        {
            String firstNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/firstNames.txt";
            return ReturnRandomLine(firstNames);
        }

        public string GenerateLastName()
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/lastNames.txt";
        ...
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/Street.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GenerateStreetNumber()
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/StreetNumber.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GenerateCity()
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/City.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GenerateProvince()
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/Province.txt";
            return ReturnRandomLine(lastNames);
        }

        public string GeneratePostalCode()
        {
            String lastNames = @"/Users/sonamvadsaria/Documents/GitHub/MCDA5510_Assignments/ConsoleApp1/ConsoleApp1/PostalCode.txt";
            return ReturnRandomLine(lastNames);
        }
